...
namespace LetsEncryptMikroTik.Core
{
    ...
    {
        public static readonly LeUri StagingV2 = new LeUri(Certes.Acme.WellKnownServers.LetsEncryptStagingV2);
        public static readonly LeUri LetsEncryptV2 = new LeUri(Certes.Acme.WellKnownServers.LetsEncryptV2);
