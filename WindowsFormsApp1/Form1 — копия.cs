    ...
    public partial class Form1 : Form
    {
        ...
        private async void Button_Start_Click(object sender, EventArgs e)
        {
            var config = new ConfigClass
            {
                ...
                MikroTikLogin = textBox_MtLogin.Text.Trim(),
                MikroTikPassword = textBox_mtPassword.Text,
                UseSsl = checkBox_ssl.Checked,
                ...
                LetsEncryptAddress = (Uri)comboBox_lec.SelectedValue,
                SaveFile = checkBox_saveFile.Checked,
            };

            var program = new LetsEncryptMikroTik.Program(config);
            ...
            try
            {
                await program.RunAsync(new Log(this));
            }
            catch (Exception ex)
            {
